...
static slsMesh _mesh_factory(Vertex *verts, GLuint *index,int nverts,int nindex);
...
slsMesh cube_mesh()
{
    ...
    slsMesh cube = _mesh_factory(vertptr, indptr, nverts, nindex);
    free(vertptr);
    free(indptr);
    return cube;
}
...
slsMesh plane_mesh()
{
    ...
    slsMesh plane = _mesh_factory(vertptr, indptr, nverts, nindex);
    free(vertptr);
    free(indptr);
    return plane;
}
